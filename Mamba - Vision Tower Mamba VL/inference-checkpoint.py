...
def generate_response(image_path, text_prompt, model_saved, 
    ...
    text_prompt += " Please summarize the analysis in approximately 250 words, organizing the summary into paragraphs."
...
if __name__ == "__main__":
    ...
    model_saved = "/scratch/faaraan/mamba-chat/Mamba - Vision Tower Mamba VL/checkpoints/epoch_5.pt"
